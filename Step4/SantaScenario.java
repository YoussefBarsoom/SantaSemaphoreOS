...
public class SantaScenario {
	...
	public Semaphore goToDoor = new Semaphore(1);
	public Semaphore elfinTrouble = new Semaphore(1);
	public Semaphore elvesWaitingTrouble = new Semaphore(0);
		...
		for(; scenario.day < 500; scenario.day++) {
			...
			if(scenario.elvesWaiting.size()>2)
			{
				...
				if(scenario.santa.elvesAtDoor.isEmpty())
				{
					...
					scenario.elvesWaitingTrouble.release();
